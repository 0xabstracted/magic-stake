...
impl ProbableRateReward {
    ...
    pub fn update_accrued_probable_reward(
        ...
        if farmer_reward.probable_reward.is_staked()
            && farmer_reward.probable_reward.is_time_to_graduate(now_ts)?
        {
    ...
    pub fn enroll_probable_farmer(
        ...
        farmer_reward.probable_reward.begin_probable_staking_ts =
            original_staking_start.unwrap_or(now_ts);
        farmer_reward.probable_reward.begin_probable_schedule_ts = now_ts;
        let bonus_time = farmer_reward.probable_reward.loyal_staker_bonus_time()?;
        ...
        //update farmer
        farmer_reward.probable_reward.probable_last_updated_ts = now_ts;
        farmer_reward.probable_reward.promised_probable_schedule = self.probable_schedule;
        farmer_reward.probable_reward.promised_probable_duration = remaining_duration;
    ...
    pub fn graduate_probable_farmer(
        ...
        let original_begin_staking_ts = farmer_reward.probable_reward.begin_probable_staking_ts;
        ...
        farmer_reward.probable_reward = FarmerProbableRateReward::default();
